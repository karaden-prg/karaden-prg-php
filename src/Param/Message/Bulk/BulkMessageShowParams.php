...
class BulkMessageShowParams extends BulkMessageParams
{
    public string $id;
    ...
    {
        return sprintf("%s/%s", static::CONTEXT_PATH, $this->id);
    }
    ...
    public static function newBuilder(): BulkMessageShowParamsBuilder
    {
